...
In a warehouse automation system, robotic movement paths are modeled with domino-like tiles on a `2 × n` grid.
...
Explanation: Two vertical dominoes side by side. The first has 3 color choices; the second has 2. Total `3 × 2 = 6`.
